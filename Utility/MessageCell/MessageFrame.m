...
- (void)setMessage:(Message *)message{
    ...
    if (_showTime){
        ...
        CGSize timeSize = [_message.time sizeWithAttributes:@{UIFontDescriptorSizeAttribute: @"12"}];
   ...
   //
    CGSize size = CGSizeMake(kContentW, CGFLOAT_MAX);
    NSDictionary *attr = @{NSFontAttributeName: kContentFont};
    CGSize contentSize = [_message.content boundingRectWithSize:size options:NSStringDrawingUsesLineFragmentOrigin|NSStringDrawingUsesFontLeading attributes:attr context:nil].size;
