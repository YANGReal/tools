...
//        fireEmitter.renderMode = kCAEmitterLayerBackToFront;
        ...
        fire.color = [[UIColor colorWithRed:252/255.0 green:217/255.0 blue:1/255.0 alpha:0.8] CGColor];  //粒子颜色
        //fire.contents = (id)[[UIImage imageNamed:@"Particles_fire.png"] CGImage];
        fire.contents = (id)[[UIImage imageNamed:@"snow.png"] CGImage]; //cell内容，一般是一个CGImage
        fire.velocity = 30;     //速度
